from flask import Flask, request, redirect, url_for, render_template, flash, send_from_directory, make_response
import pymysql
import logging
import os
import uuid
...
def index():
    try:
        ...
        response = make_response(render_template('index.html', posts=posts, page=page, total_pages=total_pages))
